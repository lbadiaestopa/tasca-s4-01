<div>
    ...
    <div>
        ...
        <a href="{{ route('orchestras.show', $orchestra) }}" class="block p-2 rounded-lg hover:bg-[#F2F2F2] transition mt-2">
            <p>{{ $orchestra->name }}</p>
        </a>
        ...
        <div class="ml-4">
            ...
            <a href="{{ route('programs.show', ['orchestra' => $orchestra, 'program' => $program]) }}" class="block p-2 rounded-lg hover:bg-[#F2F2F2] transition">
                <p>{{ $program->name }}</p>
            </a>

            <div class="ml-4">
                @foreach($program->events as $event)
                <a href="{{ route('events.show', ['orchestra' => $orchestra, 'program' => $program, 'event' => $event]) }}" class="block p-2 rounded-lg hover:bg-[#F2F2F2] transition">
                    <p>
                        {{ $event->name }} -
